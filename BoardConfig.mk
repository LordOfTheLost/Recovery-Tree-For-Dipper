...
TARGET_RECOVERY_FSTAB := $(DEVICE_PATH)/recovery/fstab/recovery.fstab
PRODUCT_COPY_FILES += $(DEVICE_PATH)/recovery/fstab/twrp.flags:$(TARGET_COPY_OUT_RECOVERY)/root/system/etc/twrp.flags
endif
